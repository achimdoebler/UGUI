...
// for giving valuable suggestions, reporting bugs and adding several new
// features. Andrey also put a lot of work in the implementaion of anti-aliased
// font support.
//
...
/* Static functions */
static UG_RESULT
_UG_WindowDrawTitle(UG_WINDOW* wnd);
static void
_UG_WindowUpdate(UG_WINDOW* wnd);
static UG_RESULT
_UG_WindowClear(UG_WINDOW* wnd);
static void
_UG_TextboxUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
static void
_UG_ButtonUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
static void
_UG_CheckboxUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
static void
_UG_ImageUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
static void
_UG_PutChar(char chr,
            UG_S16 x,
            UG_S16 y,
            UG_COLOR fc,
            UG_COLOR bc,
...
UG_FillFrame(UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c)
{
    ...
    if (gui->driver[DRIVER_FILL_FRAME].state & DRIVER_ENABLED) {
        if (((UG_RESULT(*)(
              UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c))gui
               ->driver[DRIVER_FILL_FRAME]
    ...
    if (filled) {
        ...
        for (y = miny; (y <= maxy); y++) {
            ...
            for (i = 0; (i < n); i++) {
                ...
                if ((y >= y1) && (y < y2)) {
                    polyInts[ints++] = (UG_S16)((float)((y - y1) * (x2 - x1)) /
                                                  (float)(y2 - y1) +
                                                0.5 + x1);
...
UG_ConsolePutString(const char* str)
{
    ...
    while (*str != 0) {
        ...
        if (gui->console.y_pos + gui->font.char_height > gui->console.y_end) {
            ...
            UG_FillFrame(gui->console.x_start,
                         gui->console.y_start,
                         gui->console.x_end,
                         gui->console.y_end,
...
#ifdef USE_FONT_VECTOR_CYRILLIC
    if (font->font_type ==
        FONT_TYPE_VECTOR_1BPP) // vector font could not use acceleration,
    {
        UG_VECT_FONT* fnt;
        ...
        i = 0;
        while (fnt->p[bt][i] != 0) {
            UG_DrawLine(x + ((((UG_S16)fnt->p[bt][i]) - 48) *
                             actual_char_width / fnt->char_code_width),
                        y + ((((UG_S16)fnt->p[bt][i + 1]) - 48) *
                             font->char_height / fnt->char_code_height),
                        x + ((((UG_S16)fnt->p[bt][i + 2]) - 48) *
                             actual_char_width / fnt->char_code_width),
                        y + ((((UG_S16)fnt->p[bt][i + 3]) - 48) *
                             font->char_height / fnt->char_code_height),
                        fc);
            i += 4;
        }
      ...
      if (gui->driver[DRIVER_FILL_AREA].state & DRIVER_ENABLED) {
        //(void(*)(UG_COLOR))
        push_pixel = ((void* (*)(UG_S16, UG_S16, UG_S16, UG_S16))gui
                        ->driver[DRIVER_FILL_AREA]
                        .driver)(
        ...
        if (font->font_type == FONT_TYPE_1BPP) {
            ...
            index =
              (bt - font->start_char) * font->char_height * font->char_width;
            for (j = 0; j < font->char_height; j++) {
                for (i = 0; i < actual_char_width; i++) {
                    b = font->p[index++];
                    color =
                      ((((fc & 0xFF) * b + (bc & 0xFF) * (256 - b)) >> 8) &
                       0xFF) | // Blue component
                      ((((fc & 0xFF00) * b + (bc & 0xFF00) * (256 - b)) >> 8) &
                       0xFF00) | // Green component
                      ((((fc & 0xFF0000) * b + (bc & 0xFF0000) * (256 - b)) >>
                        8) &
...
_UG_PutText(UG_TEXT* txt)
{
    ...
    while (1) {
        ...
        while ((*c != 0) && (*c != '\n')) {
            ...
            sl++;
            wl +=
              (txt->font->widths ? txt->font->widths[*c - txt->font->start_char]
                                 : char_width) +
              char_h_space;
            c++;
        }
        ...
        while ((*str != '\n')) {
            ...
            xp += (txt->font->widths
                     ? txt->font->widths[chr - txt->font->start_char]
                     : char_width) +
                  char_h_space;
        }
        str++;
...
static UG_OBJECT*
_UG_GetFreeObject(UG_WINDOW* wnd)
{
    UG_U8 i;
...
static UG_OBJECT*
_UG_SearchObject(UG_WINDOW* wnd, UG_U8 type, UG_U8 id)
{
    UG_U8 i;
    UG_OBJECT* obj = (UG_OBJECT*)wnd->objlst;
...
static UG_RESULT
_UG_DeleteObject(UG_WINDOW* wnd, UG_U8 type, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
static void
_UG_ProcessTouchData(UG_WINDOW* wnd)
{
    UG_S16 xp, yp;
    UG_U16 i, objcnt;
    UG_OBJECT* obj;
...
static void
_UG_UpdateObjects(UG_WINDOW* wnd)
{
    UG_U16 i, objcnt;
    UG_OBJECT* obj;
    UG_U8 objstate;
...
static void
_UG_HandleEvents(UG_WINDOW* wnd)
{
    UG_U16 i, objcnt;
    UG_OBJECT* obj;
    UG_U8 objstate;
...
static void
_UG_DrawObjectFrame(UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_COLOR* p)
{
    // Frame 0
...
static void
_UG_SendObjectPrerenderEvent(UG_WINDOW* wnd, UG_OBJECT* obj)
{
    UG_MESSAGE msg;
...
static void
_UG_SendObjectPostrenderEvent(UG_WINDOW* wnd, UG_OBJECT* obj)
{
    UG_MESSAGE msg;
...
UG_WindowResize(UG_WINDOW* wnd, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye)
{
    ...
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        ...
        if ((wnd->state & WND_STATE_VISIBLE) && (gui->active_window == wnd)) {
            ...
            if (wnd->xs)
                UG_FillFrame(
                  0, wnd->ys, wnd->xs - 1, wnd->ye, gui->desktop_color);
            pos = wnd->xe + 1;
            if (!(pos > xmax))
...
UG_RESULT
UG_WindowSetTitleText(UG_WINDOW* wnd, char* str)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->title.str = str;
        wnd->state |= WND_STATE_UPDATE | WND_STATE_REDRAW_TITLE;
...
UG_RESULT
UG_WindowSetTitleTextFont(UG_WINDOW* wnd, const UG_FONT* font)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->state |= WND_STATE_UPDATE | WND_STATE_REDRAW_TITLE;
        wnd->title.font = font;
...
UG_RESULT
UG_WindowSetTitleTextHSpace(UG_WINDOW* wnd, UG_S8 hs)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_RESULT
UG_WindowSetTitleTextVSpace(UG_WINDOW* wnd, UG_S8 vs)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_RESULT
UG_WindowSetTitleTextAlignment(UG_WINDOW* wnd, UG_U8 align)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_RESULT
UG_WindowSetTitleHeight(UG_WINDOW* wnd, UG_U8 height)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_RESULT
UG_WindowSetXStart(UG_WINDOW* wnd, UG_S16 xs)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->xs = xs;
...
UG_RESULT
UG_WindowSetYStart(UG_WINDOW* wnd, UG_S16 ys)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->ys = ys;
        if (UG_WindowResize(wnd, wnd->xs, wnd->ys, wnd->xe, wnd->ye) ==
...
UG_RESULT
UG_WindowSetXEnd(UG_WINDOW* wnd, UG_S16 xe)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->xe = xe;
        if (UG_WindowResize(wnd, wnd->xs, wnd->ys, wnd->xe, wnd->ye) ==
...
UG_RESULT
UG_WindowSetYEnd(UG_WINDOW* wnd, UG_S16 ye)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        wnd->ye = ye;
        if (UG_WindowResize(wnd, wnd->xs, wnd->ys, wnd->xe, wnd->ye) ==
...
UG_RESULT
UG_WindowSetStyle(UG_WINDOW* wnd, UG_U8 style)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        /* 3D or 2D? */
...
UG_COLOR
UG_WindowGetForeColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->fc;
...
UG_COLOR
UG_WindowGetBackColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->bc;
...
UG_COLOR
UG_WindowGetTitleTextColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->title.fc;
...
UG_COLOR
UG_WindowGetTitleColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->title.bc;
...
UG_COLOR
UG_WindowGetTitleInactiveTextColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->title.ifc;
...
UG_COLOR
UG_WindowGetTitleInactiveColor(UG_WINDOW* wnd)
{
    UG_COLOR c = C_BLACK;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        c = wnd->title.ibc;
...
char*
UG_WindowGetTitleText(UG_WINDOW* wnd)
{
    char* str = NULL;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        str = wnd->title.str;
...
UG_FONT*
UG_WindowGetTitleTextFont(UG_WINDOW* wnd)
{
    UG_FONT* f = NULL;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_S8
UG_WindowGetTitleTextHSpace(UG_WINDOW* wnd)
{
    UG_S8 hs = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_S8
UG_WindowGetTitleTextVSpace(UG_WINDOW* wnd)
{
    UG_S8 vs = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_U8
UG_WindowGetTitleTextAlignment(UG_WINDOW* wnd)
{
    UG_U8 align = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
...
UG_U8
UG_WindowGetTitleHeight(UG_WINDOW* wnd)
{
    UG_U8 h = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        h = wnd->title.height;
...
UG_S16
UG_WindowGetXStart(UG_WINDOW* wnd)
{
    UG_S16 xs = -1;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        xs = wnd->xs;
...
UG_S16
UG_WindowGetYStart(UG_WINDOW* wnd)
{
    UG_S16 ys = -1;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        ys = wnd->ys;
...
UG_S16
UG_WindowGetXEnd(UG_WINDOW* wnd)
{
    UG_S16 xe = -1;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        xe = wnd->xe;
...
UG_S16
UG_WindowGetYEnd(UG_WINDOW* wnd)
{
    UG_S16 ye = -1;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        ye = wnd->ye;
...
UG_U8
UG_WindowGetStyle(UG_WINDOW* wnd)
{
    UG_U8 style = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        style = wnd->style;
...
UG_RESULT
UG_WindowGetArea(UG_WINDOW* wnd, UG_AREA* a)
{
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        a->xs = wnd->xs;
        a->ys = wnd->ys;
...
UG_S16
UG_WindowGetInnerWidth(UG_WINDOW* wnd)
{
    UG_S16 w = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        w = wnd->xe - wnd->xs;
...
UG_S16
UG_WindowGetOuterWidth(UG_WINDOW* wnd)
{
    UG_S16 w = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        w = wnd->xe - wnd->xs;
...
UG_S16
UG_WindowGetInnerHeight(UG_WINDOW* wnd)
{
    UG_S16 h = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        h = wnd->ye - wnd->ys;
...
UG_S16
UG_WindowGetOuterHeight(UG_WINDOW* wnd)
{
    UG_S16 h = 0;
    if ((wnd != NULL) && (wnd->state & WND_STATE_VALID)) {
        h = wnd->ye - wnd->ys;
...
_UG_WindowClear(UG_WINDOW* wnd)
{
    if (wnd != NULL) {
        if (wnd->state & WND_STATE_VISIBLE) {
            ...
            UG_FillFrame(
              wnd->xs, wnd->ys, wnd->xe, wnd->ye, gui->desktop_color);
...
UG_RESULT
UG_ButtonDelete(UG_WINDOW* wnd, UG_U8 id)
{
    return _UG_DeleteObject(wnd, OBJ_TYPE_BUTTON, id);
}

UG_RESULT
UG_ButtonShow(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_ButtonHide(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetForeColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR fc)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetBackColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR bc)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetAlternateForeColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR afc)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetAlternateBackColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR abc)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetText(UG_WINDOW* wnd, UG_U8 id, char* str)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetFont(UG_WINDOW* wnd, UG_U8 id, const UG_FONT* font)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetStyle(UG_WINDOW* wnd, UG_U8 id, UG_U8 style)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetHSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 hs)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetVSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 vs)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_RESULT
UG_ButtonSetAlignment(UG_WINDOW* wnd, UG_U8 id, UG_U8 align)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
...
UG_COLOR
UG_ButtonGetForeColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_ButtonGetBackColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_ButtonGetAlternateForeColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_ButtonGetAlternateBackColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_COLOR c = C_BLACK;
...
char*
UG_ButtonGetText(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    char* str = NULL;
...
UG_FONT*
UG_ButtonGetFont(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_FONT* font = NULL;
...
UG_U8
UG_ButtonGetStyle(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_U8 style = 0;
...
UG_S8
UG_ButtonGetHSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_S8 hs = 0;
...
UG_S8
UG_ButtonGetVSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_S8 vs = 0;
...
UG_U8
UG_ButtonGetAlignment(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_BUTTON* btn = NULL;
    UG_U8 align = 0;
        ...
        if (obj->state & OBJ_STATE_VISIBLE) {
            ...
            if (!(btn->style & BTN_STYLE_NO_BORDERS)) {
                if (btn->style & BTN_STYLE_3D) { /* 3D */
                    _UG_DrawObjectFrame(obj->a_abs.xs,
                                        obj->a_abs.ys,
                                        obj->a_abs.xe,
                                        obj->a_abs.ye,
                                        (btn->state & BTN_STATE_PRESSED)
                    ...
                    UG_DrawFrame(obj->a_abs.xs,
                                 obj->a_abs.ys,
                                 obj->a_abs.xe,
                                 obj->a_abs.ye,
                                 (btn->state & BTN_STATE_PRESSED) ? btn->abc
                                                                  : btn->afc);
                }
            }
        } else {
            if (!(btn->style & BTN_STYLE_NO_FILL))
                UG_FillFrame(obj->a_abs.xs,
                             obj->a_abs.ys,
                             obj->a_abs.xe,
                             obj->a_abs.ye,
                             wnd->bc);
 ...
 */
UG_RESULT
UG_CheckboxCreate(UG_WINDOW* wnd,
                  UG_CHECKBOX* chb,
                  UG_U8 id,
                  UG_S16 xs,
                  UG_S16 ys,
...
UG_RESULT
UG_CheckboxDelete(UG_WINDOW* wnd, UG_U8 id)
{
    return _UG_DeleteObject(wnd, OBJ_TYPE_CHECKBOX, id);
}

UG_RESULT
UG_CheckboxShow(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_CheckboxHide(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_CheckboxSetCheched(UG_WINDOW* wnd, UG_U8 id, UG_U8 ch)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetForeColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR fc)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetBackColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR bc)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetAlternateForeColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR afc)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetAlternateBackColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR abc)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetText(UG_WINDOW* wnd, UG_U8 id, char* str)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetFont(UG_WINDOW* wnd, UG_U8 id, const UG_FONT* font)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetStyle(UG_WINDOW* wnd, UG_U8 id, UG_U8 style)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_CheckboxSetHSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 hs)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetVSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 vs)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_RESULT
UG_CheckboxSetAlignment(UG_WINDOW* wnd, UG_U8 id, UG_U8 align)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
...
UG_U8
UG_CheckboxGetChecked(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_U8 c = 0;
...
UG_COLOR
UG_CheckboxGetForeColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_CheckboxGetBackColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_CheckboxGetAlternateForeColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_CheckboxGetAlternateBackColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_COLOR c = C_BLACK;
...
char*
UG_CheckboxGetText(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    char* str = NULL;
...
UG_FONT*
UG_CheckboxGetFont(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_FONT* font = NULL;
...
UG_U8
UG_CheckboxGetStyle(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_U8 style = 0;
...
UG_S8
UG_CheckboxGetHSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_S8 hs = 0;
...
UG_S8
UG_CheckboxGetVSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_S8 vs = 0;
...
UG_U8
UG_CheckboxGetAlignment(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_CHECKBOX* btn = NULL;
    UG_U8 align = 0;
...
_UG_CheckboxUpdate(UG_WINDOW* wnd, UG_OBJECT* obj)
{
    ...
    if (obj->state & OBJ_STATE_UPDATE) {
        ...
        if (obj->state & OBJ_STATE_VISIBLE) {
            ...
            d2 = (chb->font->char_width < chb->font->char_height)
                   ? chb->font->char_height
                   : chb->font->char_width;
            ...
            /* Draw Checkbox X */
            if (chb->checked) {
                UG_DrawLine(obj->a_abs.xs + d + 1,
                            obj->a_abs.ys + d,
                            obj->a_abs.xs + d2 + d - 1,
                            obj->a_abs.ys + d2 + d - 2,
                            chb->fc);
                UG_DrawLine(obj->a_abs.xs + d,
                            obj->a_abs.ys + d,
                            obj->a_abs.xs + d2 + d - 1,
                            obj->a_abs.ys + d2 + d - 1,
                            chb->fc);
                ...
                UG_DrawLine(obj->a_abs.xs + d2 + d - 1,
                            obj->a_abs.ys + d + 1,
                            obj->a_abs.xs + d + 1,
                            obj->a_abs.ys + d2 + d - 1,
                            chb->fc);
                UG_DrawLine(obj->a_abs.xs + d2 + d - 1,
                            ...
                            obj->a_abs.ys + d2 + d - 1,
                            chb->fc);
                UG_DrawLine(obj->a_abs.xs + d2 + d - 2,
                            obj->a_abs.ys + d,
                            obj->a_abs.xs + d,
                            obj->a_abs.ys + d2 + d - 2,
                            chb->fc);
            ...
            if (!(chb->style & CHB_STYLE_NO_BORDERS)) {
                if (chb->style & CHB_STYLE_3D) { /* 3D */
                    _UG_DrawObjectFrame(obj->a_abs.xs,
                                        obj->a_abs.ys,
                                        obj->a_abs.xs + d2 + 2 * d - 1,
                                        obj->a_abs.ys + d2 + 2 * d - 1,
                                        (chb->state & CHB_STATE_PRESSED)
                                          ? (UG_COLOR*)pal_checkbox_pressed
                                          : (UG_COLOR*)pal_checkbox_released);
                } else { /* 2D */
                    UG_DrawFrame(obj->a_abs.xs,
                                 obj->a_abs.ys,
                                 obj->a_abs.xs + d2 + 2 * d - 1,
                                 obj->a_abs.ys + d2 + 2 * d - 1,
                                 (chb->state & CHB_STATE_PRESSED) ? chb->abc
                                                                  : chb->afc);
                }
            }
        } else {
 ...
 */
UG_RESULT
UG_TextboxCreate(UG_WINDOW* wnd,
                 UG_TEXTBOX* txb,
                 UG_U8 id,
                 UG_S16 xs,
                 UG_S16 ys,
...
UG_RESULT
UG_TextboxDelete(UG_WINDOW* wnd, UG_U8 id)
{
    return _UG_DeleteObject(wnd, OBJ_TYPE_TEXTBOX, id);
}

UG_RESULT
UG_TextboxShow(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_TextboxHide(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_TextboxSetForeColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR fc)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetBackColor(UG_WINDOW* wnd, UG_U8 id, UG_COLOR bc)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetText(UG_WINDOW* wnd, UG_U8 id, char* str)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetFont(UG_WINDOW* wnd, UG_U8 id, const UG_FONT* font)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetHSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 hs)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetVSpace(UG_WINDOW* wnd, UG_U8 id, UG_S8 vs)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_RESULT
UG_TextboxSetAlignment(UG_WINDOW* wnd, UG_U8 id, UG_U8 align)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
...
UG_COLOR
UG_TextboxGetForeColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_COLOR c = C_BLACK;
...
UG_COLOR
UG_TextboxGetBackColor(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_COLOR c = C_BLACK;
...
char*
UG_TextboxGetText(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    char* str = NULL;
...
UG_FONT*
UG_TextboxGetFont(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_FONT* font = NULL;
...
UG_S8
UG_TextboxGetHSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_S8 hs = 0;
...
UG_S8
UG_TextboxGetVSpace(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_S8 vs = 0;
...
UG_U8
UG_TextboxGetAlignment(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
    UG_TEXTBOX* txb = NULL;
    UG_U8 align = 0;
...
UG_RESULT
UG_ImageDelete(UG_WINDOW* wnd, UG_U8 id)
{
    return _UG_DeleteObject(wnd, OBJ_TYPE_IMAGE, id);
}

UG_RESULT
UG_ImageShow(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_ImageHide(UG_WINDOW* wnd, UG_U8 id)
{
    UG_OBJECT* obj = NULL;
...
UG_RESULT
UG_ImageSetBMP(UG_WINDOW* wnd, UG_U8 id, const UG_BMP* bmp)
{
    UG_OBJECT* obj = NULL;
    UG_IMAGE* img = NULL;
